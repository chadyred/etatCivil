...
/**
 * MentionMarginaleDeces form base class.
 *
 * @method MentionMarginaleDeces getObject() Returns the current form's model object
 *
 * @package    etatcivil
 * @subpackage form
 * @author     Boyer Jimmy
 ...
 */
abstract class BaseMentionMarginaleDecesForm extends BaseFormDoctrine
{
