...
/**
 * Image_registreDeces form base class.
 *
 * @method Image_registreDeces getObject() Returns the current form's model object
 *
 * @package    etatcivil
 * @subpackage form
 * @author     Boyer Jimmy
 ...
 */
abstract class BaseImage_registreDecesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('image_registre_deces[%s]');
