...
/**
 * ImageRegistreDeces form base class.
 *
 * @method ImageRegistreDeces getObject() Returns the current form's model object
 *
 * @package    etatcivil
 * @subpackage form
 * @author     Boyer Jimmy
 ...
 */
abstract class BaseImageRegistreDecesForm extends BaseFormDoctrine
{
