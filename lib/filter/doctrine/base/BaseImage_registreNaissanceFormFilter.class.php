...
/**
 * Image_registreNaissance filter form base class.
 *
 * @package    etatcivil
 * @subpackage filter
 * @author     Boyer Jimmy
 ...
 */
abstract class BaseImage_registreNaissanceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('image_registre_naissance_filters[%s]');
